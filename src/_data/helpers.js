module.exports = {
   ...
   * https://learn-eleventy.pages.dev/lesson/7/
   *
  ...
  getLinkActiveState(itemUrl, pageUrl) {
    ...
    // We're on the current page; let the screen reader know
    if (itemUrl === pageUrl) {
      response = ' aria-current="page"';
    }

    // We're on a child of the current page; add a CSS hook
   ...
   * https://learn-eleventy.pages.dev/lesson/13/
   *
